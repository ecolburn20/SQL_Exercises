...
-- Using your gwsis database, develop a stored procedure that will drop an individual students enrollment 
-- from a class. Be sure to refer to the existing stored procedures, enroll_student
-- and terminate_all_class_enrollment in the gwsis database for reference.
-- The procedure should be called terminate_student_enrollment and should accept the course code, 
-- section, student ID, and effective date of the withdrawal as parameters.
